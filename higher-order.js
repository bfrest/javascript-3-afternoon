...
/*
  Use a high order method to create to get the sum of bobsTotal. TODO: 
*/
let bobsPrices = [];
for (let key in purchases) {
  if (purchases[key].owner === "Bob") {
    bobsPrices.push(purchases[key].price);
  }
}
bobsTotal = bobsPrices.reduce((accumulator, current) => accumulator + current);
